  ...
  return (
    ...
    >
        ...
        <div className='flex flex-col gap-7 mb-10 text-[28px]'>
            <a href='https://github.com/jigneshdpanchal/' target='_blank'><IoLogoGithub className="cursor-pointer text-purple-600 hover:scale-110 transition-all ease-in-out"/></a>
            <a href='https://facebook.com/JigneshDPanchal' target='_blank'><IoLogoFacebook className="cursor-pointer text-purple-600 hover:scale-110 transition-all ease-in-out"/></a>
            <a href='https://in.linkedin.com/in/jignesh-panchal-seo' target='_blank'>
            <IoLogoLinkedin className="cursor-pointer text-purple-600 hover:scale-110 transition-all ease-in-out"/></a>
            <a href='https://twitter.com/JigneshDPanchal' target='_blank'>
